...
#define PSTORAGE_FLASH_PAGE_END     256

#define PSTORAGE_NUM_OF_PAGES       20                                                          /**< Number of flash pages allocated for the pstorage module excluding the swap page, configurable based on system requirements. */
#define PSTORAGE_MIN_BLOCK_SIZE     0x0008                                                      /**< Minimum size of block that can be registered with the module. Should be configured based on system requirements, recommendation is not have this value to be at least size of word. */
...
#define PSTORAGE_CMD_QUEUE_SIZE     8                                                          /**< Maximum number of flash access commands that can be maintained by the module for all applications. Configurable. */
