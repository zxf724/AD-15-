...
#define KEY1                    (GPIO_ReadInputDataBit(PORT_KEY1, (GPIO_Pin_TypeDef)PIN_KEY1) == 0)
#define KEY2                    (GPIO_ReadInputDataBit(PORT_KEY2, (GPIO_Pin_TypeDef)PIN_KEY2) == 0)
#define KEY3                    (GPIO_ReadInputDataBit(PORT_KEY3, (GPIO_Pin_TypeDef)PIN_KEY3) == 0)
#define KEY4                    (GPIO_ReadInputDataBit(PORT_KEY4, (GPIO_Pin_TypeDef)PIN_KEY4) == 0)
